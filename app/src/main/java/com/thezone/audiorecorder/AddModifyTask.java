...
public class AddModifyTask extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydb = new DBHelper1(getApplicationContext());
    ...
    public void init_modify() {
        toolbar_title.setText("Изменить задачу");
    ...
    public void saveTask(View v) {
        ...
        if (edit_text.getText().toString().trim().length() > 0) {
            ...
            if (isModify) {
                ...
                Toast.makeText(getApplicationContext(), "Задача изменена.", Toast.LENGTH_SHORT).show();
            } else {
