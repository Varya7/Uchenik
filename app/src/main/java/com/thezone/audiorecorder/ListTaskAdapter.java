...
public class ListTaskAdapter extends BaseAdapter {
    ...
    private DBHelper1 database;

    public ListTaskAdapter(Activity a, ArrayList<HashMap<String, String>> d, DBHelper1 mydb) {
        activity = a;
        data = d;
        database = mydb;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ListTaskViewHolder1 holder = null;
        if (convertView == null) {
            holder = new ListTaskViewHolder1();
            ...
            holder = (ListTaskViewHolder1) convertView.getTag();
        }


        final HashMap<String, String> singleTask = data.get(position);
        final ListTaskViewHolder1 tmpHolder = holder;
